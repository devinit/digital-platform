...
exports.csv=
{
 ...
 "country-year/oda.2014.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2014 ) sq ",
 "country-year/oda.2013.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2013 ) sq ",
 "country-year/oda.2012.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2012 ) sq ",
 "country-year/oda.2011.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2011 ) sq ",
 "country-year/oda.2010.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2010 ) sq ",
 "country-year/oda.2009.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2009 ) sq ",
 "country-year/oda.2008.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2008 ) sq ",
 "country-year/oda.2007.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2007 ) sq ",
 "country-year/oda.2006.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2006 ) sq ",
 "country-year/oda.2005.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2005 ) sq ",
 "country-year/oda.2004.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2004 ) sq ",
 "country-year/oda.2003.csv": " ( SELECT * FROM fact.\"oda_2012\" WHERE year=2003 ) sq ",

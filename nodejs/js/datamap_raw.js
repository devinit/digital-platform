 ...
 */
 ...
 "country-year/oda-donor/oda-adaptation-fund.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'adaptation-fund' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-AE.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'AE' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-afdb.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'afdb' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-afdf.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'afdf' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-arab-fund-afesd.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'arab-fund-afesd' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-asdb.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'asdb' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-asdb-special-funds.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'asdb-special-funds' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-AT.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'AT' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-AU.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'AU' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-badea.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'badea' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-BE.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'BE' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-BG.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'BG' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-CA.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'CA' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-cardb.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'cardb' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-ceb.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'ceb' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-CH.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'CH' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-cif.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'cif' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-CY.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'CY' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-CZ.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'CZ' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-DE.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'DE' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-DK.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'DK' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-EE.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'EE' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-ES.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'ES' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-EU.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'EU' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-fao.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'fao' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-FI.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'FI' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-FR.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'FR' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-gavi.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'gavi' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-GB.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'GB' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-gef.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'gef' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-gggi.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'gggi' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-global-fund.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'global-fund' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-GR.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'GR' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-HR.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'HR' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-HU.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'HU' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-iaea.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'iaea' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-ibrd.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'ibrd' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-ida.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'ida' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-idb.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'idb' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-idb-special-fund.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'idb-special-fund' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-IE.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'IE' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-ifad.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'ifad' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-IL.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'IL' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-imf-concessional-trust-funds.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'imf-concessional-trust-funds' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-international-labour-organisation.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'international-labour-organisation' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-IS.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'IS' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-islamic-dev-bank.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'islamic-dev-bank' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-IT.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'IT' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-JP.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'JP' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-KR.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'KR' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-KW.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'KW' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-KZ.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'KZ' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-LI.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'LI' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-LT.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'LT' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-LU.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'LU' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-LV.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'LV' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-montreal-protocol.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'montreal-protocol' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-MT.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'MT' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-NL.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'NL' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-NO.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'NO' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-nordic-dev-fund.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'nordic-dev-fund' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-NZ.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'NZ' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-ofid.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'ofid' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-osce.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'osce' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-PL.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'PL' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-PT.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'PT' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-RO.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'RO' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-RU.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'RU' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-SA.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'SA' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-SE.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'SE' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-SI.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'SI' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-SK.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'SK' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-TH.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'TH' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-TL.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'TL' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-TR.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'TR' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-TW.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'TW' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unaids.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unaids' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-undp.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'undp' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unece.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unece' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unep.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unep' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unfpa.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unfpa' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unhcr.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unhcr' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unicef.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unicef' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unpbf.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unpbf' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-unrwa.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'unrwa' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-US.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'US' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-wfp.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'wfp' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",
 "country-year/oda-donor/oda-who.csv": "(SELECT to_di_id, year, ROUND\(SUM\(value\), 2\) AS \"value\" FROM fact.\"oda_2015\" WHERE from_di_id = 'who' GROUP BY to_di_id, year ODER BY year DESC, to_di_id) sq",

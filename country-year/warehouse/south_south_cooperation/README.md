...
Here is a list of all the tables that were developed to support the visualisations relating to south-south cooperation. 
All of these tables are stored in the `south_south_cooperation` shema in the ddw DB on 213.168.251.124.
